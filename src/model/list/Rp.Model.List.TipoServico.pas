...
type
  iListTipoServico = Interface
    ...
    function SetData(aJson: TJSONValue): TTipoServico;
    function SetList(aJson: TJSONArray): TTipoServico;
    function SetDataSet(aJson: TJSONArray): iListTipoServico;
    function SetObject(aObject : TTipoServico) : TTipoServico;
...
function TListTipoServico.SetData(aJson: TJSONValue): TTipoServico;
var
...
function TListTipoServico.SetList(aJson: TJSONArray): TTipoServico;
var
  I: Integer;
begin
  FList.Clear;
  ...
  Result := FList.Items[I-1];
end;

function TListTipoServico.SetObject(aObject: TTipoServico): TTipoServico;
begin
  FList.Add(aObject);
